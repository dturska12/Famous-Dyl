...
const Minter = (props) => {
  ...
  const onMintPressed = async () => { //TODO: implement
    const { status } = await mintNFT(artist,artwork,waveform,name,genre,album,url,description);
    setStatus(status);
  };
    ...
    <>
      <AppBar position="fixed" className={classes.appBar}>
        ...
        <Typography variant="h6" noWrap>
          ...
          <Breadcrumbs aria-label="breadcrumb" className={classes.pageLinks}>
            ...
            <Typography color="textPrimary">Mint</Typography>
          </Breadcrumbs>
        </Toolbar>
      </AppBar>
      <br />
      ...
      <div className="Minter">
        ...
        <form>
          ...
          <input
            type="text"
            placeholder="e.g. https://dyl.pinata.cloud/ipfs/<hash>"
          ...
          <input
            type="text"
            placeholder="e.g. Jordan Belford"
            onChange={(event) => setName(event.target.value)}
          />
          <h2>Artist: </h2>
          <input
            type="text"
            placeholder="e.g. Famous Dyl ;)"
            onChange={(event) => setArtist(event.target.value)}
          />
          <h2>Album: </h2>
          <input
            type="text"
            placeholder="e.g. CryptoRich ;)"
            onChange={(event) => setAlbum(event.target.value)}
          />
          <h2>Description: </h2>
          <input
            type="text"
            placeholder="e.g. It's about Jordan, and his Burberry Shirt ;)"
