     ...
     axios
        .post(url, data, {
            ...
            headers: {
                ...
                pinata_secret_api_key: '85548bccfd501af0c3ed406ebb89c8c7e1ed0ff60551708169243e199e2f729f'
            }
        })
  ...
  return (
    <>
      ...
      <form>
            ...
            <h3> Your url is : <h3 id="urlTitle"> https://dyl.pinata.cloud/ipfs/{IPFSHash} </h3> </h3>
    </>
  );
};
